...
const catSectionTemplates = [
  ...
  },
  {
    ...
    bullets: [
      { label: 'Purring', text: 'Often a sign of contentment, though cats may also purr when anxious or in pain.' },
      { label: 'Tail Position', text: 'A tail held high usually indicates a happy, confident cat, while a puffed-up tail signals fear or aggression.' },
      { label: 'Slow Blinks', text: 'When a cat slowly blinks at you, it\'s a sign of trust and affection—often called a "cat kiss."' },
    ],
    closing:
...
const inspirationSectionTemplates = [
  ...
  },
  {
    ...
    bullets: [
      { label: 'Declutter', text: 'A tidy space reduces mental noise and helps you focus on what matters most.' },
      { label: 'Visual Reminders', text: 'Place quotes, photos, or notes that reflect your goals where you\'ll see them daily.' },
      { label: 'Limit Distractions', text: 'Identify what pulls your attention away and set gentle boundaries to protect your focus.' },
    ],
    closing:
...
const generalSectionTemplates = [
  ...
  },
  {
    ...
    bullets: [
      { label: 'How often?', text: 'Consistency matters more than perfection—find a rhythm that works for your lifestyle.' },
      { label: 'What if I make mistakes?', text: 'Mistakes are part of learning. Adjust and keep going rather than giving up entirely.' },
      { label: 'When will I see results?', text: 'Progress varies, but patience paired with steady effort almost always pays off.' },
    ],
    closing:
